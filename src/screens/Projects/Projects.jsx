...
const projectsData = [
  {
    id: 1,
    title: 'LifeAid',
    description: 'This is my final year project created using React Native and Firebase.',
    image: '../../../public/projects/lifeAid.png', // replace with your image path
    link: 'https://github.com/your-profile/javascript-projects',
  },
  {
    id: 2,
    title: 'Python',
    description: 'Proficient in Python for data analysis, web development, and automation',
    image: '../../../public/projects/lifeAid.png', // replace with your image path
    ...
    <div>
      ...
      <div className="projects-container" {...handlers}>
        ...
        <div className="projects-card" key={projectsData[currentIndex].id}>
          <img src={projectsData[currentIndex].image} alt={projectsData[currentIndex].title} />
          ...
          <a href={projectsData[currentIndex].link} target="_blank" rel="noopener noreferrer">
            <i className="uil uil-github"></i> View Projects
          </a>
        </div>
